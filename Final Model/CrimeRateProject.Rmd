...
# Abstract
  ...
  Violent crimes are a deeply human issue influencing millions of Americans daily. Many factors intertwine to create a butterfly effect that ripples across racial, economic, and social boundaries and contribute to the staggering crime rates. This study collects data for some factors that plausibly affect violent crime rate and attempts to share insight into what factors significantly influence violent crimes. Through Least Absolute Shrinkage and Selection Operator (LASSO) to filter significant variables, as well as using backward selection to further eliminate insignificant factors, we are able to present three models that began with different inclusion of variables. In using testing data to calculate the error of each model, the final LASSO model shows that percentage of people owning house, black/African American and mixed race population rate appears to have positive correlation with violent crime rates, though causation cannot be proven with statistical tools. Meanwhile, percentage of people with college plus degree and high speed Internet access seems to decrease violent crime rates, still without evidence of causation.
